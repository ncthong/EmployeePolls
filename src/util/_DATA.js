let users = {
  sarahedo: {
    ...
    name: 'Sarah Edo',
    password:'1234567',
    avatarURL: '/employee-polls/images/avatars/gorilla.png',
    answers: {
  ...
  thongnc: {
    ...
    password:'abc321',
    avatarURL: '/employee-polls/images/avatars/hacker.png',
    answers: {
  ...
  johndoe: {
    ...
    name: 'John Doe',
    password:'123123',
    avatarURL: '/employee-polls/images/avatars/dog.png',
    answers: {
  ...
  zoshikanlu: {
    ...
    avatarURL: '/employee-polls/images/avatars/giraffe.png',
    answers: {
